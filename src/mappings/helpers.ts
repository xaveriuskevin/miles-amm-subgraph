...
export const FACTORY_ADDRESS = '0xa5ad06e9e70fde3011489a4fbfa49ce4cbd1d583' // TODO: update address
...
export function convertEthToDecimal(mnt: BigInt): BigDecimal {
  return mnt.toBigDecimal().div(exponentToBigDecimal(18))
}
...
export function createLiquiditySnapshot(position: LiquidityPosition, event: EthereumEvent): void {
  ...
  snapshot.token0PriceUSD = token0.derivedMNT.times(bundle.mntPrice)
  snapshot.token1PriceUSD = token1.derivedMNT.times(bundle.mntPrice)
