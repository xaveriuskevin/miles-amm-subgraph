...
export function updateUniswapDayData(event: EthereumEvent): UniswapDayData {
  ...
  if (uniswapDayData === null) {
    ...
    uniswapDayData.dailyVolumeMNT = ZERO_BD
    uniswapDayData.dailyFeeMNT = ZERO_BD
    uniswapDayData.dailyFeeUSD = ZERO_BD
    uniswapDayData.totalVolumeUSD = ZERO_BD
    uniswapDayData.totalVolumeMNT = ZERO_BD
    uniswapDayData.dailyVolumeUntracked = ZERO_BD
  }

  uniswapDayData.totalLiquidityUSD = uniswap.totalLiquidityUSD
  uniswapDayData.totalLiquidityMNT = uniswap.totalLiquidityMNT
...
export function updateTokenDayData(token: Token, event: EthereumEvent): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.priceUSD = token.derivedMNT.times(bundle.mntPrice)
  ...
  tokenDayData.totalLiquidityMNT = token.totalLiquidity.times(token.derivedMNT as BigDecimal)
  tokenDayData.totalLiquidityUSD = tokenDayData.totalLiquidityMNT.times(bundle.mntPrice)
